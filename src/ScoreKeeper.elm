...
play play =
    li []
        [ i [ class "delete", onClick (DeletePlay play) ] [ text "Delete" ]
        , div [] [ text play.name ]
...
player player =
    li []
        [ i [ class "edit", onClick (Edit player) ] [ text "Edit" ]
        , div []
            [ text player.name ]
        , button [ type_ "button", onClick (Score player 2) ]
            [ text "2pt" ]
        , button [ type_ "button", onClick (Score player 3) ]
            [ text "3pt" ]
        , div []
...
playerForm model =
    Html.form [ onSubmit Save ]
        [ input
            ...
            []
        , button [ type_ "button", onClick Save ] [ text "Submit" ]
